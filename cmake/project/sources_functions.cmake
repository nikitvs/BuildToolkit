...
# Функции cmake для работы с исходниками проекта
...
#[====[.rst:
    ...
    **Описание**
    ...
    Функция назначает указанному таргету исходные файлы из выбранных директорий.
    ...
    В качестве аргументов должны быть переданы:
        - целевой таргет для подключения исходных файлов;
...
#[====[.rst:
    ...
    **Описание**
    ...
    Функция назначает указанному таргету выбранные директории и все их поддиректории.
    Опционально можно указать модификатор видимости директорий для внешних таргетов.
    По умолчанию берется модификатор PUBLIC.

    В качестве аргументов должны быть переданы:
        - целевой таргет для подключения исходных файлов;
        - список директорий для назначения;
    ...
    **Аргументы**
    ...
    -                       ``TARGET`` - Целевой таргет
    -                 ``INCLUDE_DIRS`` - Список директорий для
